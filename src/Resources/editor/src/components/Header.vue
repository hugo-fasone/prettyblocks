  ...
  >
    <div class="flex items-center gap-2">
      <div class="border-r border-gray-200">
        ...
        <ButtonLight
          @click="hideLeftPanelAction"
          :class="hideLeftPanel ? 'bg-black bg-opacity-10 rotate-180' : ''"
          icon="ArrowLeftOnRectangleIcon"
          class="p-2"
        />
        <ButtonLight
          @click="changeLeftPanelSize"
          :class="extendLeftPanel ? 'bg-black bg-opacity-10' : 'rotate-180'"
          icon="ArrowLeftOnRectangleIcon"
          class="p-2"
        />
      </div>
    ...
    <div class="flex items-center gap-3">
      <div class="border-r">
        <ButtonLight
          @click="changeRightPanelSize"
          :class="extendRightPanel ? 'bg-black bg-opacity-10' : 'rotate-180'"
        ...
        <ButtonLight
          @click="showSettings()"
          :class="settingsEnabled ? 'bg-black bg-opacity-10' : ''"
          icon="WrenchScrewdriverIcon"
          class="p-2"
        />
        <ButtonLight
          @click="hideRightPanelAction"
          :class="hideRightPanel ? 'bg-black bg-opacity-10 rotate-180' : ''"
          icon="ArrowRightOnRectangleIcon"
          class="p-2"
        />
        <ButtonLight
