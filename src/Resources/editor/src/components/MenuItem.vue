...
emitter.on("setSelectedElement", (notFormattedId) =>
  setSelectedElement(notFormattedId)
);
...
<template>
  <div :class="[
    ...
    <div class="menu-item-actions w-0 overflow-hidden flex justify-end items-center">
      ...
      <LanguageModal v-if="showModal" :id_prettyblocks="props.element.id_prettyblocks" :languages="languages"
        @closeModal="closeModal" @selectLanguages="selectLanguages" />
